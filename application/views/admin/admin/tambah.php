            ...
            <div class="card-body">
                <form method="post" action="<?=base_url('admin/insert')?>">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password" id="password" name="password"value="" class="form-control" value="password">
                    </div>
                    <div class="form-group mb-3">
                        <label for="konfirmasi-password">Konfirmasi Password</label>
                        <input type="password" id="konfirmasi-password" class="form-control" name="konfirmasi-password" value="">
                    </div>
