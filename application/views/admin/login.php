...
<head>
    ...
    <body class="authentication-bg authentication-bg-pattern">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="auth-title">Halaman Administrator</h5>
        ...
        $(document).ready(function(){
            ...
            var url = "<?=base_url('index.php/loginadmin/check_account');?>";
            ...
            $.ajax({
                ...
                if (msg.message == "success") {
                ...
                }else if(msg.message=="expired"){
                    $('.alert').removeAttr('style');
                    $('.alert').html("Masa Berlaku akun anda sudah habis");
                    setTimeout(function(){
                    $('.alert').css("display","none");
                    },3000);
                    ...
                    let confir = confirm('Apakah Ingin Membayar ? ');
                    if (confir) {
                        window.location.href = "<?=base_url('login/pembayaran/62')?>";
                    }
                    }
                }
